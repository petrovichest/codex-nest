...
В покое фон прозрачен. Если журнал доступен, наведение и клавиатурный фокус
поднимают контрол: `--color-floating` и `--chat-shadow`; нажатие использует
продавливание с внутренней тенью. Фокус дополнительно обозначается видимым контуром. Область нажатия
...
| ------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Тон поверхностей          | Привести `--sidebar-surface` в тёмной теме, шапку, планы и остальные нейтральные карточки чата к `--color-floating`; формы вопросов уже переведены                    |
| Кнопки остальных экранов  | Перевести оставшиеся действия чата и настроек на объём по общей таблице; навигация, композер, его меню, формы вопросов и статус работы уже используют новые состояния |
