...
| ---------------------------------------------------------------------------------------- | -------------------------------- | ---------------------------------------------------------- |
| Подписи, описания, метаданные, время, подзаголовки                                       | `--text-small`, `--text-caption` | `12px`                                                     |
| Компактные действия, переключатель «Проекты / Активные», подписи панели композера        | `--text-small`                   | `12px`                                                     |
| Основной UI, названия сессий, обычные кнопки, подписи полей                              | `--text-ui`, `--text-label`      | `14px`                                                     |
| Компактный заголовок сессии в верхней панели чата                                        | `--text-ui`                      | `14px`, без уменьшения на телефоне                         |
| Блоки кода, технические журналы, таблицы                                                 | `--text-ui`                      | `14px`; встроенный код наследует размер окружающего текста |
...
Снимки реализованной типографики в чате и настройках:
...
<p>
  ...
  <a href="assets/typography-desktop-settings.png"><img src="assets/typography-desktop-settings.png" width="420" alt="Настройки на компьютере: заголовки 18px, поля 16px, подписи 14px" /></a>
</p>
