...
область экрана. Экономия высоты достигается компоновкой и отступами: размеры
шрифтов, иконок и областей нажатия сохраняются. Название имеет вес `400` и размер
`16px` на компьютере, `14px` на телефоне; подпись проекта — `11px`.
Все действия остаются на месте. На компьютере название и проект стоят в одну
строку, на телефоне — в две компактные строки.
