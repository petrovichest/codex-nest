...
accept-all certificate handler). Android-клиент доверяет только системным
центрам сертификации; используйте сертификат от системно доверенного CA или
Tailscale HTTPS, а не установленный вручную пользовательский CA.
